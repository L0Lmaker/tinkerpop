...
func (channelResultSet *channelResultSet) GetError() error {
	return channelResultSet.loadError()
}

func (channelResultSet *channelResultSet) loadError() error {
	channelResultSet.errMutex.Lock()
	defer channelResultSet.errMutex.Unlock()
...
func (channelResultSet *channelResultSet) One() (*Result, bool, error) {
	if err := channelResultSet.loadError(); err != nil {
...
func (channelResultSet *channelResultSet) All() ([]*Result, error) {
	...
	return results, channelResultSet.loadError()
}
